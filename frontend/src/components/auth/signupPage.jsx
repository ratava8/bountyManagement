                                                ...
                                                <div className="space-y-4 md:space-y-6">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            type="text" name="discordName" id="discord" className="bg-gray-50 border-[1px] border-gray-300 text-gray-900 outline-none sm:text-sm rounded-lg focus:ring-[#256fc4] focus:border-[#256fc4] block w-full p-2.5 dark:bg-[#1e2738] dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-[#4f4f4f] dark:border-[#303030]" required="" />
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div className="flex items-start">
                                                        <div className="flex items-center h-5">
                                                            ...
                                                            }} id="terms" aria-describedby="terms" type="checkbox" className="w-4 h-4 border-[1px] outline-none border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-[#256fc4] dark:bg-[#1e2738] dark:border-gray-600 dark:focus:ring-[#256fc4] dark:ring-offset-gray-800" required="" />
                                                        </div>
