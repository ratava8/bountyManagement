...
export function Projects(project) {
    ...
    return (
        <div className="w-[460px] flex-col flex justify-start items-center mt-[20px]">
            <Card className="rounded-[10px] project_dropdown h-[440px] w-[90%] border-[1px] shadow-sm dark:bg-[#151e2d] bg-[#fff] border-none" style={{ gap: "0", border: "none", padding: '0px', borderRadius: '10px' }}>
                <div
                    className="flex justify-between px-[10px] w-[413px] -ml-[24px] -mt-[23px] rounded-t-[10px] h-[100px] dark:bg-[#1e2738] bg-[#e1e1e1] flex justify-center items-center">
                ...
                <div className="h-full flex flex-col justify-start w-full" style={{ fontFamily: 'Smack' }}>
                    <div className=" mt-[-10px] flex justify-between items-center">
                        ...
                        <div className='flex gap-[10px]'>
                            <div className='flex py-[3px] hover:cursor-pointer' onClick={handleLike}>
                                {!project.likes?.includes(user?._id) ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 dark:text-gray-200">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 dark:text-gray-200">
                            ...
                            <div className='flex py-[3px] hover:cursor-pointer' onClick={handleDisLike}>
                                {!project.disLikes?.includes(user?._id) ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 dark:text-gray-200">
                    ...
                    <div className="dark:bg-[#0c1320] p-[10px] bg-[#f6f6f6] w-[108%] ml-[-14px] rounded-[10px] mt-[10px]">
            ...
            {openDetailModal ?
                <div className='fixed top-[0px] left-0 w-screen h-screen flex justify-center items-center z-[99]'>
                    ...
                    <Zoom duration={500}>
                        <div className='fixed w-[500px] rounded-[10px] h-auto flex justify-start items-center top-[100px] z-50 bg-[#eee] dark:bg-[#151e2d] shadow-md'>
                            <div className=' w-full h-full'>
                                ...
                                <div className="w-full px-[40px] justify-center items-center text-center mt-[20px]">
                                    <div className=" w-full h-[100px] text-[14px] text-left overflow-y-scroll dark:text-gray-300 whitespace-pre-line">
                                ...
                                <div className="flex flex-col justify-center items-center mb-[50px]" style={{ fontFamily: 'Smack' }}>
                                    <div className="relative flex flex-col items-center rounded-[10px] w-[700px] max-w-[95%] mx-auto bg-clip-border shadow-3xl shadow-shadow-500 dark:text-white dark:!shadow-none p-3">
                                        <div className="grid md:grid-cols-2 gap-2 px-2 w-full mt-[50px]">
                                            <div className="flex flex-col  rounded-[10px] bg-[#fff] bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:bg-[#1e2738] dark:shadow-none">
                                                ...
                                                <div className="text-base flex justify-start items-center font-medium text-navy-700 pl-[30px] mt-[20px] dark:text-gray-200" style={{ marginBottom: "0" }}>
                                                    {
                                                        project.developers.map((a, idx) =>
                                                            // <UserAvatar user={a} />
                                                            <img key={idx} className="rounded-[50%] w-[40px] h-[40px] -ml-[15px]" style={{ maxWidth: " max-content" }} src={(a?.avatar === 'default' || !a?.avatar) ? '/images/12.png' : `${process.env.REACT_APP_API_BASE_URL}/${a?.avatar}`} alt="" />
                                                        )
                                                    }
                                                </div>
                                            </div>
