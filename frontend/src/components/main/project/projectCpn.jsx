...
function ProjectCpn() {
    ...
    const handleCreateTicket = async () => {
        ...
        if (developer === '') {
            NotificationManager.error('Choose a developer', 'Error')
            return
        }
        try {
            const data = {
            ...
            <div className='w-full flex'>
                    ...
                    <div className='flex'>
                        <div className='w-[25%] text-center'>
                            <img
                                alt=""
                                src={projectImg}
                                className="mb-3 rounded-full w-[80%] mx-auto shadow-lg"
                            />
                        ...
                        <div className="w-[75%] px-3 gap-[20px] mt-[-20px] cursor-pointer" style={{ fontFamily: 'Smack' }}>
                            <div className="items-center pt-[50px] p-[20px]  gap-[40px]">

                                <div>
                                    <h5 className="mb-1 text-xl font-medium text-[rgb(25,118,210)] dark:text-white">{project.title}</h5>
                                    <div className="text-sm text-gray-500 dark:text-gray-400 h-[100px]">{project.description}</div>
                                </div>


                            </div>
                            <div className="px-[137px] flex items-center gap-[20px]">
                ...
                <div className='px-[10px] w-[25%]'>
                    <div className="p-[30px] w-[100%] h-[300px] border-[1px] rounded-[5px] shadow-sm dark:bg-[rgb(36,36,36)] bg-[#fff] border-none" style={{ gap: "0", border: "none" }}>
                        ...
                        <div className='border-b-[1px] border-[#8080807d]  py-[15px]'>
                            <div className='flex'>
                                <div className='w-[50%]'>
                                    <div className='flex py-[3px] hover:cursor-pointer'>
                                        {false ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        ...
                                        <span className='dark:text-gray-200'>5 Stars</span>
                                    </div>
                                    <div className='flex py-[3px]'>
                                        ...
                                        <span className=' dark:text-gray-200'>7 Views</span>
                                    </div>
                                </div>
                                <div className='w-[50%]'>
                                    <div className='flex py-[3px] hover:cursor-pointer'>
                                        ...
                                        <span className='dark:text-gray-200'>5 Likes</span>
                                    </div>
                                    <div className='flex py-[3px] hover:cursor-pointer'>
                                        {false ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        ...
                                        <span className='dark:text-gray-200'>7 Dislikes</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="rounded-[5px] w-[25%] h-[300px] border-[1px] shadow-sm dark:bg-[rgb(36,36,36)] bg-[#fff] border-none" style={{ gap: "0", border: "none" }}>
                    <Chart
                        ...
                        width={"100%"}
                        height={'100%'}
                        className="dark:bg-[rgb(36,36,36)] bg-[#ffffff00]"
                    />
                </div>
